...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Main\StateRepository")
 */
class State
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Main\Country", inversedBy="states")
     * @ORM\JoinColumn(nullable=false)
     */
    private $country;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Main\County", mappedBy="state", orphanRemoval=true)
     */
    private $counties;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Main\Tax", mappedBy="state", orphanRemoval=true)
     */
    private $taxes;
